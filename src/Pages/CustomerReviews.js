      ...
      <Card  >
        <Card.Body>
          <div className='card-top'>
            ...
            <img className='yelp-rating' src='./yelp-stars.png' alt='rating' />
          </div>

          <Card.Text>
            I had this AWFUL and scary problem with my Subaru Forester: it kept rattling sooo badly that it felt like you're driving on cobblestone and you can barely hear the music in the car at high speeds... I know we have terrible roads in SD but this was not just the roads. <br/><br/>
            I got a diagnosis with a mechanic in SD but I got a recommendation to Tom and his crew here. Tom offered to fix THE problem, along with other concerns for WAAAAY cheaper. I knew it was going to be an awful drive up full of anxiety but Tom told me that it'll feel bad, but I'd be okay to get here. He was right, sitting in the waiting room now while they fix my control arm.<br/><br/>
            Even while being here, the front desk (Kevin) and the mechanics (Dennis, Dustin, Nico) are all so nice and they were really good at explaining the issues. They even confirmed with me that my fears while driving were super valid since they did the road test. The situation is not nice but the validation was. <br/><br/>
            Tom and team made sure everything was good, and even stayed late to get things completed because they knew we had to drive back to San Diego. It was amazing.<br/><br/>
            They also do not upsell. So important in a mechanic, as you all know.<br/><br/>
